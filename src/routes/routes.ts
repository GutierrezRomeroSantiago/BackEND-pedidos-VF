...
class Routes {
    ...
    //Obtención de las prendas con el pedido al que corresponden
    ...
    // Obtención del pedido con las prendas correspondientes
    ...
    //Obtención de una prenda mediante su ID
    ...
    //Obtener una prenda mediante ID
    ...
    //Modificar un usuario del sistema pudiendo cambiar el nombre de usuario y contraseña
    ...
    //Modificar el estado de un pedido de true a false y viceversa
    ...
    //Borrar una prenda mediante su ID
    ...
    //Borrar un pedido mediante su ID
    ...
    //Hacer una busqueda en la coleccion de usuarios con el fin de validar al usuario que se está logeando
    ...
    //Mediante esta fnción nos planteamos dos objetivos, en primer lugar obtener el número de cada tipo de prenda que tenemos en cada tipo de pedido,
    //es decir, el numero de calzados, joyas y abrigos que hay en cada pedido normal. Y en segundo lugar calculamos el beneficio total que estan generando
    //las prendas que se ubican en un pedido normal y las prendas que se ubican en un pedido expres
    ...
    //Meiante esta función nos planteamos el objetivo de realizar una serie de calculos refereidos a los precios de venta y compra de las prendas y
